  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSignUp} className="space-y-4">
        ...
        <div>
          <label htmlFor="email-signup" className="block text-sm font-medium text-gray-400 mb-1">Email</label>
          <input
            id="email-signup"
            type="email"
            value={email}
        ...
        <div>
          <label htmlFor="password-signup" className="block text-sm font-medium text-gray-400 mb-1">Password</label>
          <input
            id="password-signup"
            type="password"
            value={password}
